...
MITZICOM MULTI-TIER APPLICATION - Ansible Playbooks / Ansible Tower

This has been modernised for use under OpenStack, which did not exist before to make the
project IaC centric, automatically provisioning the entire environment and running the 
necessary minimal smoke tests

Re-read the below and imagine that it has been much improved by Red Hat Consulting :)

THIS A MUCH IMPROVED AND MODULAR VERSION OF THIS OLD THING:

==== OLD README.ADOC FOLLOWS!
